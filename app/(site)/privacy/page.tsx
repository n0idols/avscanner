  ...
  return (
    <section className="max-w-6xl mx-auto px-6">
      ...
      <p>
        ...
        &quot;Our&quot; in this Agreement) refers to AV Scanner News. Cookies
        ...
        the duration of a page visit). Website refers to AV Scanner News,
        accessible from https://www.avscannernews.com/ You means the individual
        ...
        include, but is not limited to: Usage Data Usage Data is collected
        ...
        mobile device. Information from Third-Party Social Media Services The
        Company allows You to create an account and log in to use the Service
        through the following Third-party Social Media Services: Google Facebook
        Twitter If You decide to register through or otherwise grant us access
        to a Third-Party Social Media Service, We may collect Personal data that
        ...
        contact list associated with that account. You may also have the option
        of sharing additional information with the Company through Your
        Third-Party Social Media Service&apos;s account. If You choose to
        ...
        store it in a manner consistent with this Privacy Policy. Tracking
        ...
        so that it will refuse Cookies, our Service may use Cookies. Flash
        Cookies. Certain features of our Service may use local stored objects
        ...
        You close Your web browser. You can learn more about cookies here: All
        ...
        Your data and other personal information. Disclosure of Your Personal
        ...
        security. Children&apos;s Privacy Our Service does not address anyone
        ...
        questions about this Privacy Policy, You can contact us: By visiting
        this page on our website: https://www.avscannernews.com/
      </p>
    </section>
  );
};
